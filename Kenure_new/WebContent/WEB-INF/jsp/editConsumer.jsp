	...
	<div id="wrapper" data-ng-controller="customercontroller"
		...
		<div>
			<div id="consumerleftNavigationbar" data-ng-include
				data-src="'consumerLeftNavigationbar'"></div>
		</div>
		...
		<div id="content">
			...
			<h1>
				...
				<div class="rightbtns">
					<a href="consumerEPManagement" class="primary ic_back">Back</a>
				</div>
			</h1>
			<div class="middle">
					...
					<div class="box-body pad">
						<form class="" name="editConsumerForm">
									...
									<div id="disableId1" class="form-horizontal">
										...
										<div>
											<div class="form-group">
												<label class="control-label">Hosepipe :</label> <input
													type="checkbox" data-ng-model="hosepipe.value"
													style="outline: 1px solid #1e5180" disabled data-ng-disabled="true"> <span></span>
											</div>
											<div class="form-group">
												<label class="control-label">Irrigation System :</label> <input
													type="checkbox" data-ng-model="irrigationSystem.value"
							...
							<div class="bottom_buttons">
								<label class="control-label">&nbsp;</label>
								<button type="submit" data-ng-click="updateConsumer()"
