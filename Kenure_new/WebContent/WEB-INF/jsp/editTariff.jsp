		...
		<div id="content">
			...
			<div class="middle">
				...
				<div class="boxpanel">
					...
					<span class="heading">Edit Tariff</span>
					...
					<div class="box-body">
						<div class="grid-content">
							...
							<!-- <table class="grid" style="margin-top: 20px; margin-bottom: 20px">
								<tr>
									<th><h4>Tariff Name:</h4></th>
									<th><input type="text" data-ng-required="required"
										data-ng-model="tariffName"></th>
								</tr>
							</table> -->

							<div
								style="margin-top: 20px; margin-left: 40px; margin-bottom: 20px;">
								<span class="control-label required"> Tariff Name :</span> <span>
									<input type="text" data-ng-required="required"
									data-ng-model="tariffName" required>
								</span>
							</div>
								...
								<tbody>
									<tr>
										...
										<td class="row-end"><input type="number"
											...
											min="0" max="9999999999" data-ng-required="trans1.check" /></td>
										<td class="row-cost"><input type="number" min="0"
											max="9999999999" data-ng-disabled="!trans1.check"
											data-ng-model="trans1.cost" data-ng-required="trans1.check"></td>
									...
									<tr>
										...
										<td class="row-end"><input type="number"
											...
											min="0" max="9999999999" data-ng-required="trans2.check" /></td>
										<td class="row-cost"><input type="number" min="0"
											max="9999999999" data-ng-disabled="!trans2.check"
											data-ng-model="trans2.cost" data-ng-required="trans2.check"></td>
									...
									<tr>
										...
										<td class="row-end"><input type="number"
											...
											min="0" max="9999999999" data-ng-required="trans3.check" /></td>
										<td class="row-cost"><input type="number" min="0"
											max="9999999999" data-ng-required="trans3.check"
									...
									<tr>
										...
										<td class="row-end"><input type="number"
											...
											min="0" max="9999999999" data-ng-required="trans4.check" /></td>
										<td class="row-cost"><input type="number" min="0"
											max="9999999999" data-ng-required="trans4.check"
									...
									<tr>
										...
										<td class="row-end"><input type="number"
											...
											min="0" max="9999999999" data-ng-required="trans4.check" /></td>
										<td class="row-cost"><input type="number" min="0"
											max="9999999999" data-ng-required="trans5.check"
									...
									<tr>
										...
										<td class="row-end"><input type="number"
											...
											min="0" max="9999999999" data-ng-required="trans6.check" /></td>
										<td class="row-cost"><input type="number" min="0"
											max="9999999999" data-ng-required="trans6.check"
									...
									<tr>
										...
										<td class="row-start"><input type="number"
											...
											data-ng-value="trans7.startValue" min="0" max="9999999999" /></td>
										<td class="row-end"><input type="number"
											data-ng-disabled="!trans7.check" data-ng-model="trans7.end"
											min="0" max="9999999999" data-ng-required="trans7.check" /></td>
										<td class="row-cost"><input type="number" min="0"
											max="9999999999" data-ng-required="trans7.check"
									...
									<tr>
										...
										<td class="row-start"><input type="number"
											...
											data-ng-value="trans8.startValue" min="0" max="9999999999" /></td>
										<td class="row-end"><input type="number"
											data-ng-disabled="!trans8.check" data-ng-model="trans8.end"
											min="0" max="9999999999" data-ng-required="trans8.check" /></td>
										<td class="row-cost"><input type="number" min="0"
											max="9999999999" data-ng-required="trans8.check"
									...
									<tr>
										...
										<td class="row-start"><input type="number"
											...
											data-ng-value="trans9.startValue" min="0" max="9999999999" /></td>
										<td class="row-end"><input type="number"
											data-ng-disabled="!trans9.check" data-ng-model="trans9.end"
											min="0" max="9999999999" data-ng-required="trans9.check" /></td>
										<td class="row-cost"><input type="number" min="0"
											max="9999999999" data-ng-required="trans9.check"
									...
									<tr>
										...
										<td class="row-start"><input type="number"
											...
											data-ng-value="trans10.startValue" min="0" max="9999999999" /></td>
										<td class="row-end"><input type="number"
											data-ng-disabled="!trans10.check" data-ng-model="trans10.end"
											min="0" max="9999999999" data-ng-required="trans10.check" /></td>
										<td class="row-cost"><input type="number" min="0"
											max="9999999999" data-ng-required="trans10.check"
							...
							<div class="form-group"
								...
								<button
									...
									data-ng-model="editTariff" data-ng-click="addTariff()"
									type="submit">Edit Tariffs</button>
