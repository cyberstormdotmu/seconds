							...
							<div class="filter_panel">
								...
								<div class="form-group">
									<label class="control-label"><h5>Endpoint Register
										...
										data-ng-change="searchRegisterId = searchRegisterId.split(' ').join('')" autofocus="autofocus">
								</div>
								...
								<tbody>
									...
									<tr	data-ng-repeat="x in consumerList.slice(((currentPage-1)*itemsPerPage), ((currentPage)*itemsPerPage)) | orderBy:orderByField:reverseSort">
										...
										<td class="action">
											...
											<a href="" title="delete">
												<img data-ng-if="x.isActive == true" alt=""	src="images/delete-ic.png" data-ng-click="removeConsumer(x.consumerMeterId, x.registerId)">
												<img data-ng-if="x.isActive == false" alt="" src="images/delete-ic.png" data-ng-click="abortEndPointDelete()">
											</a>
										</td>
