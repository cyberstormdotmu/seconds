...
<body data-ng-app="myApp" id="admin">
	...
	<div id="wrapper" data-ng-controller="logincontroller" data-ng-init="initCountry()">
	...
	<div id="content">
		...
		<h1>Country Management
			<div class="rightbtns">
					<button class="primary ic_add pull-right" data-ng-click="editCountry()" type="submit">Add New Country</button>
				</div>
		</h1>
		<div class="middle">
			...
			<div class="boxpanel" >
				<span class="heading">Search</span>
					<div class="box-body">
						<form name="searchCountryForm">
							<div class="filter_panel">
								
								<div class="form-group">
									<label class="control-label"><h5>Country Name</h5></label> <input
										type="text" class="form-control" name="countryName" data-ng-trim="false"
										maxlength="20" data-ng-model="searchCountryName" required autofocus="autofocus">
								</div>
								
								<!-- <div class="form-group">
									<label class="control-label">Country Code</label> <input
										type="text" class="form-control" name="countryCode" data-ng-trim="false"
										maxlength="3" data-ng-model="searchCountryCode" required>
								</div> -->
								
								<div class="form-group auto">
									<label class="control-label">&nbsp;</label>
									<button class="primary ic_search" type="submit" data-ng-click="searchCountry()">Search</button>
				...
				<div class="boxpanel" data-ng-show="noCountryFoundDiv">
				...
				<div class="boxpanel" data-ng-show="countryListDiv">
					<span class="heading">Country List</span>
					<div class="box-body">
						<div class="grid-content">
							<table class="grid">
								<tr>
									<th><a style="color: white"
										data-ng-click="orderByField='countryName'; reverseSort = !reverseSort">
											Country Name <span data-ng-show="orderByField == 'countryName'">
									...
									<th><a style="color: white"
										data-ng-click="orderByField='countryCode'; reverseSort = !reverseSort">
											Country Code <span
											data-ng-show="orderByField == 'countryCode'">
											<span data-ng-show="!reverseSort" class="glyphicon glyphicon-triangle-top"></span>
												<span data-ng-show="reverseSort" class="glyphicon glyphicon-triangle-bottom"></span>
										</span>
									</a></th>
								...
								<tr data-ng-repeat="x in countryList.slice(((currentPage-1)*itemsPerPage), ((currentPage)*itemsPerPage)) | orderBy:orderByField:reverseSort">
									<td>{{x.countryName}}</td>
									<td>{{x.countryCode}}</td>
									<td class="action">
										<a href="" title="edit">
											<img alt="" src="images/edit-ic.png" data-ng-click="editCountry(x.countryId)">
										</a>&nbsp;
									</td>
								</tr>
