...
<body data-ng-app="myApp">
	...
	<div id="wrapper" data-ng-controller="consumercontroller" data-ng-init="consumerProfileInit()">
			...
			<div class="middle">
				<div class="boxpanel">
					...
					<div class="box-body pad">
						<form class="login-form" name="updateConsumerForm">
							<div class="two_col">
								<div class="col">
									<div class="form-horizontal">
										...
										<div class="form-group" data-ng-show="updateConsumerForm.email1.$error.pattern">
										...
										<div class="form-group">
											<label class="control-label">&nbsp;</label>
											<button type="submit" data-ng-click="updateConsumerProfile()" data-ng-model="updateConsumerButton" class="primary ic_submit">Update Consumer</button>
										</div>
