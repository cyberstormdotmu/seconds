...
<body>
	...
	<div class="modal-body">
		<div class="form-group">
			<ul>
				...
				<li>&nbsp;&nbsp;&nbsp;<label class="checkbox"><input type="checkbox" data-ng-model="requestToResetAllAlerts"><span><h5 style="margin-top:5px;">&nbsp;Request to reset all alerts</h5></span></label><br/></li>
	...
	<div class="modal-footer" >
		<button class="btn btn-default" type="button" data-ng-click="updateConsumerMeterAlert()">OK</button>&nbsp;&nbsp;&nbsp;&nbsp;
