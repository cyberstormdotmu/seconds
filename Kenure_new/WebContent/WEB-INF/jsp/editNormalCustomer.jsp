...
<body data-ng-app="myApp">
	...
	<div id="wrapper" data-ng-controller="normalUserController"
		data-ng-init="editNormalCustomerDetails()">
		<!--wrapper Start-->
									...
									<div class="form-horizontal">
										...
										<div class="form-group">
											<label class="control-label required">Username :</label> <input
												...
												maxlength="50" data-ng-readonly="true"
												data-ng-disabled="true">
										</div>
										<!-- <div class="form-group">
											<label class="control-label required">Dataplan
										...
										<!-- <div class="form-group">
											<label class="control-label required">DataPlan Active
										...
										<div class="form-group">
											<label class="control-label required">DataPlan Expiry
												Date:</label> <input type="text" class="form-control calendar-input"
												data-uib-datepicker-popup="{{format}}"
												placeholder="-- Click here to Select Date --"
										...
										<div class="form-group" data-ng-show="false">
											<label class="control-label required">&nbsp;</label> <input type="hidden" class="form-control"
												data-ng-model="userId">
										</div>

										<div class="form-group">
											<label class="control-label">&nbsp;</label>
											<button type="submit" data-ng-click="updateNormalCustomer()"
												data-ng-model="addUserButton" class="primary ic_submit">Update
												User</button>
											<!-- <button type="button" data-ng-click="resetPageForEditUser()" class="default ic_reset">Reset</button> -->
										</div>
