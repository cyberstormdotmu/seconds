...
<script>
	function refreshPage() {
		document.location.href=url+"/customerOperation/installerManagement";
	}
...
<body data-ng-app="myApp">
	...
	<div id="wrapper" data-ng-controller="customercontroller" 
		data-ng-init="getInstallerByCustomerId(${customerId})">
		...
		<div id="content">
			...
			<h1>
				...
				<div class="rightbtns">
					<a href="addInstallerRedirect" class="primary ic_add pull-right">Add
						New Installer</a>
				</div>
			</h1>
			<div class="middle">
			...
			<div class="status success" id="successMsgdiv" style="display: none">
						...
						<form>
							<div class="filter_panel">
								...
								<div class="form-group">
									<label class="control-label"><h5>Installer Name</h5></label> <input
										type="text" class="form-control"
										 data-ng-model="installer.name" autofocus="autofocus" required>
								</div>

								<div class="form-group auto">
									<label class="control-label">&nbsp;</label>
									<button class="primary ic_search"
										data-ng-click="searchInstaller()">Search</button>
				...
				<div class="boxpanel" data-ng-show="noInstallerFoundDiv">
				...
				<div class="boxpanel" data-ng-show="installerFoundDiv">
					<span class="heading">Installer List</span>
					<div class="box-body">
						<div class="grid-content">
							<table class="grid">
								<tr>
									...
									<th><a style="color: white"
										data-ng-click="orderByField='name'; reverseSort = !reverseSort">
											Installer Name <span data-ng-show="orderByField == 'name'">
								...
								<tr
									data-ng-repeat="x in installers.slice(((currentPage-1)*itemsPerPage), ((currentPage)*itemsPerPage)) | orderBy:orderByField:reverseSort">
									<!-- <td>{{x.id}}</td> -->
									<td>{{x.name}}</td>
									<td data-ng-if="x.status == true">Active</td>
									<td data-ng-if="x.status == false">InActive</td>
									<td class="action"><a
										href="editInstaller?installerId={{x.id}}" title="edit"> <img
											...
											data-ng-click="removeInstaller(x.id)">
									<img alt="" src="${pageContext.request.contextPath}/images/delete-ic.png" data-ng-if="x.status == false" data-ng-click="abortDeleteInstaller()">
									</a></td>
								</tr>
