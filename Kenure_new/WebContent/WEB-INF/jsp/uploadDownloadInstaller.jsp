			...
			<div class="middle">
				...
				<div class="boxpanel">
					<div class="box-body pad">
						<form action="downloadDCForInstaller" method="post">
							<div class="two_col">
								<div class="col">
									<div class="form-horizontal">
										<div class="form-group">
											...
											<!-- <label class="control-label">Header Included </label> -->
											 <input type="checkbox" style="outline: 1px solid #1e5180" name="includeHeader" checked="checked"><span></span>Header Included? &nbsp;&nbsp;&nbsp;
											<button type="submit" class="primary ic_submit">DownLoad DC File</button>
										</div>
									</div>
								</div>
							</div>
							...
							<form action="uploadDCForInstaller" method="post" enctype="multipart/form-data">
							<div class="two_col">
								<div class="col">
									<div class="form-horizontal">
										<div class="form-group">
											...
											<input type="hidden" value="${installer.installerId}" name="installerId">
										 	<input type="checkbox" style="outline: 1px solid #1e5180" name="includeHeader" checked="checked"><span></span>Header Included? &nbsp;&nbsp;&nbsp;
											<input type="file"  name="file" class="primary"/> 
											<button type="submit" class="primary ic_submit">Upload DC File</button>
										</div>
									</div>
								</div>
							</div>
