...
public interface WalletServiceClient {
	...
	TransactionQueryResult listTransactionsByAttribute(ListTransactionsByAttributeRequest request);
	...
	/**
	 * Looks up the balances of all static accounts for this user.
	 *
	 * @param userId the user to get balances for
	 * @return a list of balance results, never null
	 */
	public List<AccountBalanceResult> getAccountBalancesByUser(Long userId);
	
	public Account getOperatorAccount(Long operatorId, String currency);
	
	/**
	 * Get a unique account from a filter query.,
	 * 
	 * @param request
	 * @return Account or null if not found
	 * @throws RuntimeException if more than one account found.
	 */
