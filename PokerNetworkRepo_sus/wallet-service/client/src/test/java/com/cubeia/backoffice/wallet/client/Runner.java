...
public class Runner {
	...
	public static void main(String[] args) {
		try {
			WalletServiceClient client = new WalletServiceClientHTTP("https://localhost:9091/wallet-service-rest/rest");

//			AccountQuery query = new AccountQuery();
//			query.setType("SYSTEM_ACCOUNT");
//			query.setCurrency("EUR");
//			Account a = client.findUniqueAccount(query);
//			System.out.println("Unique account : "+a);
//			System.out.println("--------------");
