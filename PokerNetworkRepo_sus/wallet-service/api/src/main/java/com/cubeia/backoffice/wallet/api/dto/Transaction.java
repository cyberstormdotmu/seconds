...
public class Transaction implements Serializable {
    ...
    public Transaction(Long id, String externalId, Date timestamp, String comment, Map<String, String> attributes, Entry... entries) {
        this.id = id;
    ...
    public String toString() {
        return "Transaction [id=" + id + ", externalId=" + externalId + ", entries=" + entries + ", timestamp="
            + timestamp + ", comment=" + comment + ", attributes=" + attributes + "]";
    }
