...
public interface WalletServiceContract extends Contract {
	...
	/**
	 * Find a unique account that matches the query. Exceptions are thrown if more than one account matches the query. 
	 * 
	 * @param query
	 * @return Account or null if no matches
	 * @throws RuntimeException if more than one account matches the query
	 */
