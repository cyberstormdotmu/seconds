...
public interface WalletAccountingManager extends AccountingManager {
	 ...
	 */
	QueryResultsContainer<Account> listAccounts(Long accountId, Long userId, Set<AccountStatus> entityStatuses, Set<String> entityTypes, int offset, int limit,
    ...
    Account getAccountByTypeAndOperatorIdAndCurrency(String name, Long operatorId, String currencyCode);
