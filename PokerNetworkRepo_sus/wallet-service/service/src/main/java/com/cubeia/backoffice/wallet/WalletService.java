...
public interface WalletService {
	 ...
	 */
	WithdrawResult withdrawFromRemoteWalletToAccount(UUID requestId, long userId, long sessionId, long licenseeId, Money amount);
	 ...
	 * @return the created transaction
	 */
	DepositResult depositFromAccountToRemoteWallet(UUID requestId, long userId, long sessionId, long licenseeId, Money amount);
	 ...
	 */
	AccountQueryResult listAccounts(Long accountId, Long userId, Collection<Account.AccountStatus> statuses, Collection<Account.AccountType> types, int offset,
			int limit, AccountsOrder order, boolean ascending);
	 ...
	 * @return a result container
	 */
	EntriesQueryResult listEntries(Long accountId, boolean includeBalances, int offset, int limit, boolean ascending);
	 ...
	 * @return a result container
	 */
	TransactionQueryResult listTransactions(Long id1, Boolean id1credit, boolean id1IsUserId, Long id2, Boolean id2credit, boolean id2IsUserId, Date startDate,
			Date endDate, int offset, int limit, TransactionsOrder order, boolean ascending);

	/**
	 * List transactions by attribute key and value.
	 * @param accountId account id (optional)
	 * @param userId user id (optional)
	 * @param key attribute key, required
	 ...
	 * @return
	 */
    TransactionQueryResult listTransactionsByAttribute(Long accountId, Long userId, String key, String value,
    ...
    Transaction getTransactionByExternalId(String externalId);
    ...
    Long getOrCreateOperatorAccountIdForCurrency(Long operatorId, String currencyCode);

    Account findUniqueAccount(AccountQuery query);
