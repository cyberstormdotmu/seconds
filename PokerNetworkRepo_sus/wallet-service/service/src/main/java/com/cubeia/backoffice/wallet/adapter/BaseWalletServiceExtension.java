...
public class BaseWalletServiceExtension implements WalletService {
	...
	public TransactionQueryResult listTransactionsByAttribute(Long accountId, Long userId, String key, String value,
	    ...
	    return base.listTransactionsByAttribute(accountId, userId, key, value, offset, limit, order, ascending);
	}
    ...
    public Transaction getTransactionByExternalId(String externalTxId) {
        return base.getTransactionByExternalId(externalTxId);
    }
    ...
    public Long getOrCreateOperatorAccountIdForCurrency(Long operatorId, String currencyCode) {
        return base.getOrCreateOperatorAccountIdForCurrency(operatorId, currencyCode);
    }
    ...
    public Account findUniqueAccount(AccountQuery query) {
        return base.findUniqueAccount(query);
    }
}
