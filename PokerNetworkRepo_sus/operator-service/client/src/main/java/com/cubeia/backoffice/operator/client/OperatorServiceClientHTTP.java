...
public class OperatorServiceClientHTTP implements  OperatorServiceClient {
    ...
    private static final String OPERATOR_CURRENCIES     = OPERATOR+"/currencies";
    
    private static final String OPERATOR_WALLET_LOG_ID     = "/operator/wallet/log/id/%s";
    private static final String OPERATOR_WALLET_LOG_QUERY     = "/operator/wallet/log/query";
    ...
    public  OperatorServiceClientHTTP() {
        this("https://localhost:9092/operator-service-rest/rest");
    }
    ...
    @Override
    public List<OperatorCurrencyDTO> getOperatorCurrencies(Long operatorId) {
        String url = String.format(baseUrl + OPERATOR_CURRENCIES, operatorId);
        HttpMethodBase method = createGetMethod(url);
        ...
        try {
            ...
            return this.<List<OperatorCurrencyDTO>>parseList(body, new TypeReference<List<OperatorCurrencyDTO>>(){});
        } catch (Exception e) {
    ...
    @Override
    public OperatorWalletRequestLogDTO findOperatorWalletRequestById(Long requestId) {
        String url = String.format(baseUrl + OPERATOR_WALLET_LOG_ID, requestId);
        HttpMethodBase method = createGetMethod(url);
        ...
        try {
            ...
            return parseJson(body, OperatorWalletRequestLogDTO.class);
        } catch (Exception e) {
            throw new RuntimeException(e);
        } finally {
            method.releaseConnection();
    ...
    @Override
    public OperatorWalletRequestQueryResult findOperatorWalletRequestLogEntries(Long operatorId, Collection<OperatorWalletRequestStatus> statuses, int offset,
            int limit, OperatorWalletRequestOrder sortOrder, boolean ascending) {

        String url = String.format(baseUrl + OPERATOR_WALLET_LOG_QUERY);
        PutMethod method = new PutMethod(url);
        prepareMethod(method);
        
        OperatorWalletRequestQuery request = new OperatorWalletRequestQuery();
        ...
        try {
            ...
            return parseJson(body, OperatorWalletRequestQueryResult.class);
        } catch (Exception e) {
            throw new RuntimeException(e);
        } finally {
            method.releaseConnection();
