...
public class OperatorsResource {
    ...
    @Path("wallet/log/id/{walletRequestId}")
    @GET
    public OperatorWalletRequestLogDTO findAuditLogById(@PathParam("walletRequestId") Long walletRequestId) {
        OperatorWalletRequestLogDTO result = operatorWalletService.findWalletRequestLogById(walletRequestId);
        return result;
    }
    
    @Path("wallet/log/query")
    @PUT
    public OperatorWalletRequestQueryResult findAuditLog(OperatorWalletRequestQuery query) {
        OperatorWalletRequestQueryResult result = operatorWalletService.findWalletRequestLogEntries(query);
        return result;
    }
}
