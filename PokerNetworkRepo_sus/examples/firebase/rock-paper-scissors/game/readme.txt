...
$ mvn clean package firebase:run \
        -Dcom.cubeia.network.userservice.base-url=https://localhost:9090/user-service-rest/rest \
        -Dcom.cubeia.network.walletservice.base-url=https://localhost:9091/wallet-service-rest/rest \
