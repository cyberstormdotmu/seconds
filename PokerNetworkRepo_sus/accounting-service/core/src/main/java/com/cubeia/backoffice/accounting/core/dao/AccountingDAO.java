...
public interface AccountingDAO {
    ...
    List<Transaction> listTransactionsByAttribute(Long accountId, Long userId, String key, String value, int offset,
        int limit, TransactionsOrder order, boolean ascending);

    int countTransactionsByAttribute(Long accountId, Long userId, String key, String value);
    ...
    Collection<Account> findAccountsByOperatorIdAndTypeAndCurrency(String accountType, Long operatorId, String currency);

    /**
     * Find a unique account by a filter query. Will throw exception if there
     * is more than one account found by the query or null if not found.
     * 
     * @param request
     */
