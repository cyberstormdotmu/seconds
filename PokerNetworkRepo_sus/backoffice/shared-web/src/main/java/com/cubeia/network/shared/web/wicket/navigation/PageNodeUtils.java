...
public class PageNodeUtils {
    ...
    public static PageNode node(String title, Class<? extends Page> page, String icon, boolean linkable, PageNode... children){
           return node(title,null,page,icon,linkable,children);
    }
    public static PageNode node(String title, String mountPoint, Class<? extends Page> page, String icon, boolean linkable,  PageNode... children) {
        PageNode n = new PageNode(title,page,icon,linkable,mountPoint);
    ...
    public static PageNode node(String title, String mountPoint, Class<? extends Page> page) {
        return node(title,mountPoint,page,null,true,null);
    }
    public static PageNode node(String title, String mountPoint,Class<? extends Page> page, boolean linkable) {
        return node(title,mountPoint,page,null,linkable,null);
    }
    ...
    public static void add(List<PageNode> pages, String title, String mountPoint, Class<? extends Page> page, String icon,  PageNode... children) {
        pages.add(node(title,mountPoint,page,icon,true,children));
    }
    ...
    public static PageNode nodeWithChildren(String name, Class<? extends Page> page, String icon, PageNode ... children) {
        return nodeWithChildren(name,null,page,icon,children);
    }
    public static PageNode nodeWithChildren(String name, String mountPoint,Class<? extends Page> page, String icon, PageNode ... children) {
        PageNode node = node(name,mountPoint,page,null,true,null);
