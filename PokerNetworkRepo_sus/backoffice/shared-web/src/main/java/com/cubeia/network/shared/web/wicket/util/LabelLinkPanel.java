...
public class LabelLinkPanel extends Panel {
    ...
    public LabelLinkPanel(String id, IModel<String> text, Class<? extends Page> page, PageParameters params) {
        this(id, text, null, page, params);
    }
    
    public LabelLinkPanel(String id, String text, String toolTip, Class<? extends Page> page, PageParameters params) {
        this(id, Model.of(text), Model.of(toolTip), page, params);
    }
    
    public LabelLinkPanel(String id, IModel<String> text, IModel<String> toolTip, Class<? extends Page> page, PageParameters params) {
        super(id);
        BookmarkablePageLink<?> link = new BookmarkablePageLink<Void>("link", page, params);
        link.add(new Label("label", text));
        
        if (toolTip != null  &&  toolTip.getObject() != null) {
