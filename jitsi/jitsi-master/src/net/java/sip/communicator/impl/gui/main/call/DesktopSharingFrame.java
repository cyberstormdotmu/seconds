        ...
        if (initialFrame)
        {
            ...
            startButton.addActionListener(new ActionListener()
            {
                public void actionPerformed(ActionEvent e)
                {
                    ...
                    Iterator<? extends CallPeer> callpeerItr = call.getCallPeers();
                    ...
                    while(callpeerItr.hasNext())
                    {
                        ...
                        //TATVASOFT 
                        // START
                        String contact = callpeer.getAddress();
                        //Added "call" parameter for regionDesktopSharing parallel with video call(we may remove this parameter in future)
                    ...
                    //if (call != null)
                        /*CallManager.enableRegionDesktopSharing(
                                ...
                                location.y,
                                sharingRegionWidth,
                                sharingRegionHeight);                  *//*Changes Done By TATVASOFT*/ 
                    /*else*/
