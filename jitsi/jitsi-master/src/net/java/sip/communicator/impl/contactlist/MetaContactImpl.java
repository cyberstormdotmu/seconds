...
public class MetaContactImpl
    extends DataObject
    implements MetaContact,Cloneable
{
    /**
    ...
    {
        MetaContactImpl clone;
        
        if(this instanceof MetaContactImpl){
            clone = this;
        }
        clone = (MetaContactImpl) super.clone();
        clone.setParentGroup(this.getParentGroup());
        clone.setDisplayName(this.getDisplayName());
        clone.avatarFileCacheAlreadyQueried=this.avatarFileCacheAlreadyQueried;
        clone.cachedAvatar=this.cachedAvatar;
        clone.contactsOnline=this.contactsOnline;
        clone.defaultContact=this.defaultContact;
        clone.displayName=this.displayName+"- Copy";
        clone.isDisplayNameUserDefined=this.isDisplayNameUserDefined;
        clone.parentGroup=this.parentGroup;
        clone.setUid(this.getUid()+"1");
        return clone;
    }
