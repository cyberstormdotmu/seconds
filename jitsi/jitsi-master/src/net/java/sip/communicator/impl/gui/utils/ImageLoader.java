...
public class ImageLoader
{
    ...
    public static final ImageID MERGE_GROUP
    = new ImageID("service.gui.icons.MERGE_WITH_GROUP");
    ...
    // TatvaSoft
    /**
     * Broadcast Message 16x16 Icon
     */
    public static final ImageID BROADCAT_MESSAGE_16x16_ICON
        = new ImageID("service.gui.icons.BROADCAT_MESSAGE_16x16_ICON");
    /**
     * Quit 16x16 image.
     */
    ...
    */
    ...
    public static final ImageID onlineIcon 
        = new ImageID("status.online_icon");
    
    public static final ImageID offlineIcon 
    = new ImageID("status.offline_icon");
    
    public static final ImageID dndIcon 
    = new ImageID("status.dnd_icon");
    
    public static final ImageID awayIcon 
    = new ImageID("status.away_icon");
    
    public static final ImageID importIcon
    = new ImageID("service.gui.icons.IMPORT_CONTACT_16x16_ICON");
    
    public static final ImageID exportIcon
    = new ImageID("service.gui.icons.EXPORT_CONTACT_16x16_ICON");
