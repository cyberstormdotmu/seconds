                ...
                ProtocolProviderServiceJabberImpl>
{
        ...
        InfoRetreiver infoRetreiver)
    {
        ...
        XmppConnector.sslCallback = ssContactList;
    ...
    {
            ContactGroupJabberImpl t =  ssContactList.createUnresolvedContactGroup(groupUID);
            XmppConnector.sslCallback = ssContactList;
            return t;
    }
    ...
    {
        ContactJabberImpl cji =  ssContactList.findContactById(contactID);
        XmppConnector.sslCallback = ssContactList;
            return cji;
    }
