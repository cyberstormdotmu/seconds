               ...
               Skinnable
{
    ...
    /**
     * If it is a DesktopStreaming.
     */
   /* // TATVASOFT
    // START
    private final boolean desktopStreaming;
    // END
*/    /**
        ...
        boolean video, boolean existingCall)
    {
       ...
       /* this.desktopStreaming = desktopstreaming;*/// TATVASOFT
        this.video = video;
    ...
    private void initComponents()
    {
        ...
        if(video){
            /*if(!desktopStreaming){
               buttonsPanel.remove(videoCallButton);                    // TATVASOFT
            }else{*/
