...
public interface Connector {
	...
	/**
	 * Set a factory to be used for dispatcher threads. These threads are the 
	 * incoming threads executing events from a server. If not explicitly set 
	 * a single thread per connector will be used.
	 * 
	 * @param factory Factory to use, must not be null
	 */
