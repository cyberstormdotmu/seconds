...
FB_PROTOCOL.WaitingList = FB_PROTOCOL.WaitingList || {};
FB_PROTOCOL.WaitingResponsePacket = FB_PROTOCOL.WaitingResponsePacket || {};
FB_PROTOCOL.WaitingListPacket = FB_PROTOCOL.WaitingListPacket || {};
FB_PROTOCOL.WaitCheckPacket = FB_PROTOCOL.WaitCheckPacket || {};
FB_PROTOCOL.WaitCheckResponsePacket = FB_PROTOCOL.WaitCheckResponsePacket || {};
...
FB_PROTOCOL.WaitingListPacket = function() {
	this.classId = function() {
		return FB_PROTOCOL.WaitingListPacket.CLASSID;
	};

	this.tableid = {}; // int;
};

FB_PROTOCOL.WaitCheckPacket = function() {
	this.classId = function() {
		return FB_PROTOCOL.WaitCheckPacket.CLASSID;
	};
...
FB_PROTOCOL.WaitingList.CLASSID = 213;
FB_PROTOCOL.WaitingResponsePacket.CLASSID = 212;
FB_PROTOCOL.WaitingListPacket.CLASSID = 214;
//Tatvasoft Code Starts
FB_PROTOCOL.WaitCheckPacket.CLASSID = 215; 
FB_PROTOCOL.WaitCheckResponsePacket.CLASSID = 216;
//Tatvasoft Code Ends*/