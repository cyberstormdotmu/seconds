...
public interface Client {
	...
	/**
	 * Set to true if a client has connected on a remote node.
	 * This is used to suppress running disconnect logic that will break the newly connected client.
	 * @param clientConnectedRemotely
	 */
    public void setClientConnectedRemotely(boolean clientConnectedRemotely);

    /**
     * True if another client has been connected on a remote node.
     * @return true if another client connected on a remote node
     */
    boolean isClientConnectedRemotely();
