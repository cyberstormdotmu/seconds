...
(function () {
    ...
    angular.module('shoalSupplier.views.supplierCreditIntegration')
        .controller('shoalSupplier.views.supplierCreditIntegration.supplierCreditIntegrationListController', function ($q, $http,  Notification, shoalSupplier_supplierCreditIntegration_supplierCreditIntegrationService, $uibModal) {
            var vm = this,
                supplierCreditIntegrationList = shoalSupplier_supplierCreditIntegration_supplierCreditIntegrationService,
