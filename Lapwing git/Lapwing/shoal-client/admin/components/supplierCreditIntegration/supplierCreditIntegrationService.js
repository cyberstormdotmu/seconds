...
(function () {
    'use strict';
    angular.module('shoalAdmin.supplierCreditIntegration')
        .factory('shoalAdmin_supplierCreditIntegration_supplierCreditIntegrationService', function ($rootScope, $q, $http, ENV) {
