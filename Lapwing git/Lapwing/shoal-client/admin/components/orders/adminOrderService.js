...
(function () {
    ...
    angular.module('shoalAdmin.orders')
        .factory('shoalAdmin_orders_OrderService', function ($http, $q, ENV) {
            ...
            var orderAdminWebServiceUrl = ENV.webServiceUrl + "/admin/orders/",
                ...
                fetchByStatusOfBuyer = function (status, buyerId) {
                    ...
                    var defer = $q.defer();
                    $http.get(orderAdminWebServiceUrl + 'buyerOrders', {params: {status: status, buyerId: buyerId}})
                        .then(function (response) {
                            var orders = response.data;
                            defer.resolve(Object.freeze(orders));
                        }, function (response) {
                ...
                orderReturn = function (orderLine, orderReference, orderRetrunQuantity) {
                    var defer = $q.defer();
                    $http.get(orderAdminWebServiceUrl + 'orderRetrun', {params: {orderLine: orderLine, orderReference: orderReference, orderRetrunQuantity: orderRetrunQuantity}})
                        .then(function (response) {
                            var orders = response.data;
                            defer.resolve(Object.freeze(orders));
                        }, function (response) {
