...
(function () {
    ...
    angular.module('shoalAdmin.views.activeOffers')
        .controller('shoalAdmin.views.activeOffers.AdminOfferDetailsController', function ($scope, Notification, shoalAdmin_offers_OfferService, $uibModal, $stateParams) {
            var vm = this,
                ...
                recordPayment = function (outstandingBalanceOfDay) {
                    var modalInstance = $uibModal.open({
                        templateUrl: 'views/activeOffers/adminOfferPaymentView.html',
                        controller: 'shoalAdmin.views.activeOffers.AdminOfferPaymentController as vm',
                        size: 'lg',
                        resolve: {
                            report: vm.report,
