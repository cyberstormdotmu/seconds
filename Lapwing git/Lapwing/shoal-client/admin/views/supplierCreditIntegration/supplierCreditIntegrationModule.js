...
(function () {
    'use strict';
    angular.module('shoalAdmin.views.supplierCreditIntegration', ['shoalCommon.address', 'ui-notification', 'ui.bootstrap'])
        .config([function ($stateProvider, NotificationProvider) {
            $stateProvider
                ...
                .state('loggedIn.supplierCreditIntegration.list', {
                    ...
                    controller: 'shoalAdmin.views.supplierCreditIntegration.supplierCreditIntegrationListController',
                    controllerAs: 'vm'
                });
