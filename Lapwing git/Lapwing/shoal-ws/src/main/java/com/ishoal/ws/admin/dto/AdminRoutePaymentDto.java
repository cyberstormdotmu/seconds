...
public class AdminRoutePaymentDto {
	private List<RoutePaymentDetailsDto> paymentDetails;
	...
	public AdminRoutePaymentDto() {

	}

	public AdminRoutePaymentDto(Builder builder) {
	...
	public List<RoutePaymentDetailsDto> getPaymentDetails() {
	...
	public static final class Builder {
		...
		public Builder paymentDetails(List<RoutePaymentDetailsDto> val) {
			paymentDetails = val;
			return this;
		}
		...
		public AdminRoutePaymentDto build()
		{
			return new AdminRoutePaymentDto(this);
		}
	}
}
