...
INSERT INTO PRODUCTS(PRODUCT_CODE, NAME, DESCRIPTION, VENDOR_ID, PRODUCT_STOCK, TERMS_AND_CONDITIONS,REVIEW,SUITABILITY,PROCESS_NOTIFICATION,SUBMIT_NOTIFICATION)
VALUES ('HPELITE840', 'HP EliteBook 840 G2 Laptop', 'The HP EliteBook 840 thin and light notebook allows users to be ultra-productive in and out of the office. Work with confidence thanks to proven technologies, security, performance, and management features that will meet all your enterprise needs.', currval('vendors_id_seq'), 40000, 'OFFER valid for 1 week only','review','suitability',TRUE,FALSE);
