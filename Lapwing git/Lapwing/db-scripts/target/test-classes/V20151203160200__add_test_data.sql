INSERT INTO ORGANISATIONS(NAME,REGISTRATION_NUMBER,INDUSTRY,NUMBER_OF_EMPLOYEES) VALUES ('Slate Rock & Gravel Co','1111','telecom','1000');
...
INSERT INTO ORGANISATIONS(NAME,REGISTRATION_NUMBER,INDUSTRY,NUMBER_OF_EMPLOYEES) VALUES ('Pawtucket Patriot Brewery','1111','telecom','1000');
...
INSERT INTO ORDERS(BUYER_ID, BUYER_ORGANISATION_ID, VENDOR_ID, REFERENCE, STATUS, PAYMENT_STATUS, VERSION, CREATED_DATETIME, MODIFIED_DATETIME, INVOICE_DATE, PAYMENT_DUE_DATE)
VALUES((SELECT ID FROM USERS WHERE USER_NAME = 'tom@bosl.co.uk'),
       ...
       '14b95c9e-1c54-46b1-a825-befe12873e66', 'CONFIRMED', 'UNPAID', 1, TIMESTAMP'2015-09-17 00:00:00Z', TIMESTAMP'2015-09-18 00:00:00Z', DATE'2017-09-08', DATE'2017-12-08');
...
VALUES((SELECT ID FROM USERS WHERE USER_NAME = 'tom@bosl.co.uk'),
       (SELECT ID FROM ORGANISATIONS WHERE NAME = 'Bramham Office Services Ltd'),
       (SELECT ID FROM VENDORS WHERE NAME = 'HP'),
       'c175979f-d52a-4fe9-9afd-2955fde64403', 'PROCESSING', 'UNPAID', 0, TIMESTAMP'2015-09-17 00:00:00Z', TIMESTAMP'2015-09-17 00:00:00Z', DATE'2017-09-09', DATE'2017-11-08');
...
VALUES((SELECT ID FROM USERS WHERE USER_NAME = 'melissa@niddhoney.co.uk'),
       ...
       (SELECT ID FROM VENDORS WHERE NAME = 'HP'),
       'bea39549-d294-4bcb-bfa0-5d20b657e1bb', 'CONFIRMED', 'UNPAID', 1, TIMESTAMP'2015-09-17 00:00:00Z', TIMESTAMP'2015-09-18 00:00:00Z', DATE'2017-09-10', DATE'2017-12-08');
...
VALUES((SELECT ID FROM USERS WHERE USER_NAME = 'fred@srgc.com'),
       ...
       (SELECT ID FROM VENDORS WHERE NAME = 'HP'),
       '6b15aecf-e9d4-404f-86ee-067c14401045', 'CONFIRMED', 'PAID', 1, TIMESTAMP'2015-11-04 00:00:00Z', TIMESTAMP'2015-01-04 00:00:00Z', DATE'2017-09-012', DATE'2017-12-08');
...
INSERT INTO OFFER_PRICE_BANDS(OFFER_ID, MIN_VOLUME, MAX_VOLUME, BUYER_PRICE, VENDOR_PRICE, LAPWING_MARGIN, DISTRIBUTOR_MARGIN)
