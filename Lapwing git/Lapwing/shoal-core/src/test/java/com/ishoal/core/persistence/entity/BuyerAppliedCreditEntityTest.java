...
public class BuyerAppliedCreditEntityTest {

    @Test
    public void shouldBeEqualIfSameInstance() {
        BuyerAppliedCreditEntity entity = entity(1);
    ...
    private BuyerAppliedCreditEntity entity(long id) {
        BuyerAppliedCreditEntity entity = new BuyerAppliedCreditEntity();
        entity.setId(id);
        return entity;
    }
}