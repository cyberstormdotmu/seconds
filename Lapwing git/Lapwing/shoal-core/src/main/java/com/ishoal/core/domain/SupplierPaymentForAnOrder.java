...
public class SupplierPaymentForAnOrder {
	private Long id;
	private String from;
	private String to;
	...
	private SupplierPaymentForAnOrder(Builder builder) {
		this.id = builder.id;
	...
	public static Builder aSupplierPaymentForAnOrder() {
		return new Builder();
	}
	...
	public static class Builder {
		...
		public SupplierPaymentForAnOrder build() {
			return new SupplierPaymentForAnOrder(this);
		}
	}
}
