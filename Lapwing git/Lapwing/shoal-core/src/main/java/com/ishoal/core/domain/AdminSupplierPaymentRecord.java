...
public class AdminSupplierPaymentRecord {
	...
	public AdminSupplierPaymentRecord() {

	}

	public AdminSupplierPaymentRecord(Builder builder) {
	...
	public static Builder anAdminSupplierPaymentRecord() {
		return new Builder();
	}
	...
	public static final class Builder {
		...
		public AdminSupplierPaymentRecord build() {
			return new AdminSupplierPaymentRecord(this);
		}
	}
}
