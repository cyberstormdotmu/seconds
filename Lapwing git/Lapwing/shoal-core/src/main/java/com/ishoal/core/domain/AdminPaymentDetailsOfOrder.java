...
public class AdminPaymentDetailsOfOrder {
	...
	public AdminPaymentDetailsOfOrder() {

	}

	public AdminPaymentDetailsOfOrder(Builder builder) {
	...
	public static Builder anAdminRouteOneAndTwoPayment() {
		return new Builder();
	}
	...
	public static final class Builder {
		...
		public AdminPaymentDetailsOfOrder build() {
			return new AdminPaymentDetailsOfOrder(this);
		}
	}
}
