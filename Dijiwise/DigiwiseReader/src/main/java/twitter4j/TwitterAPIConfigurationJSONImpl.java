...
class TwitterAPIConfigurationJSONImpl extends TwitterResponseImpl implements TwitterAPIConfiguration {
    ...
    TwitterAPIConfigurationJSONImpl(HttpResponse res, Configuration conf)
        ...
        try {
            ...
            photoSizes.put(MediaEntity.Size.LARGE, new twitter4j.Size(sizes.getJSONObject("large")));
            JSONObject medium;
            ...
            photoSizes.put(MediaEntity.Size.MEDIUM, new twitter4j.Size(medium));
            photoSizes.put(MediaEntity.Size.SMALL, new twitter4j.Size(sizes.getJSONObject("small")));
            photoSizes.put(MediaEntity.Size.THUMB, new twitter4j.Size(sizes.getJSONObject("thumb")));
