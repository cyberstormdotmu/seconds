...
<form:form action="${pageContext.request.contextPath}/user/loginMain.html" method="POST">
	...
	<h1 id="popup_page"><spring:message code="logout.message"/><a href="${pageContext.request.contextPath}/home.html" class="close"  style="left: 93%"></a></h1>
	<div class="box-content" onclick="closeError()">
	    ...
	    <div class="row"></div>
	    <div class="row" style="margin-left: 31%"><input name="" type="submit" class="inputbutton" value="<spring:message code="button.login"/>" /></div>
