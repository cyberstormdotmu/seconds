...
<form:form action="${pageContext.request.contextPath}/user/login.html" method="POST" onsubmit="return validation();">
	...
	<h1 id="popup_page"><spring:message code="login.message" /><a href="${pageContext.request.contextPath}/home.html" class="close" style="left: 93%"></a></h1>
	<div class="box-content" onclick="closeError()">
		<div class="contblock">
		    ...
		    <div class="row"><input name="" type="submit" class="inputbutton" value='<spring:message code="button.login"></spring:message>' />
