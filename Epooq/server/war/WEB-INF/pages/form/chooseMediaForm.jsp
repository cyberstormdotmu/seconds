...
<script type="text/javascript">
	...
	{			
		...
		{	
			var storyPagesIndex = "${fn:length(story.storyPages)}";
			...
			document.getElementById("addVideo").href = "${pageContext.request.contextPath}"+"/story/edit/addVideoForm.html";
			document.getElementById("addAudio").href = "${pageContext.request.contextPath}/story/edit/addAudioForm.html";
		}else{
			var storyPagesIndex = "${fn:length(newStory.storyPages)}";
			document.getElementById("pageIndex").innerHTML= parseInt(storyPagesIndex) + 1;
		}
...
/* 			var action="${pageContext.request.contextPath}/story/edit/addAudioForm.html";
			document.getElementById("audioForm").action=action; */
			...
			/* var action="${pageContext.request.contextPath}/story/addAudioForm.html";
			document.getElementById("audioForm").action=action; */
		}
	...
	function storyPageExists() {
		...
		if(story_mode.value=="EDIT")
		{
			...
			if (storyPages == "[]") {
				alert("<spring:message code="alert.noPage_exist" />");
				return false;
			}
		}
		else
...
<h1 id="popup_page">
	<spring:message code="chooseMedia.message"></spring:message>
...
<div class="box-content">
    ...
    <div class="innercontent">
		...
		<div class="mediapart">
			...
			<a href="${pageContext.request.contextPath}/story/addVideoForm.html" id="addVideo">
				<img class="form_image" src="${pageContext.request.contextPath}/resources/img/moviemedia.png">
			</a>
		...
		<div class="mediapart">
			<form:form action="${pageContext.request.contextPath}/story/addImage.html" method="post" enctype="multipart/form-data">
      		...
      		<a href="#" onclick="document.getElementById('imageUpload').click(); return false;">
      			<img class="form_image" src="${pageContext.request.contextPath}/resources/img/picmedia1.png">
      		</a>
		</div>
		
		<div class="mediapart">
			<form:form id="audioForm" enctype="multipart/form-data">
				<!-- <input type="file" id="audioUpload" name="file" onchange="addAudio()" style="visibility: hidden; width: 1px; height: 1px;" /> -->
				<input type="text" id="description" name="description" style="visibility: hidden; width: 1px; height: 1px;">
				<input type="submit" id="submitAudio" value="Tallenna" style="visibility: hidden; width: 1px; height: 1px;">
			</form:form>
			<a href="${pageContext.request.contextPath}/story/addAudioForm.html" id="addAudio">
      			<img class="form_image" src="${pageContext.request.contextPath}/resources/img/soundmedia1.png">
      		</a>
		...
		<div class="mediapart">
			...
			<a href="#" onclick="addText(); return false;">
				<img class="form_image" src="${pageContext.request.contextPath}/resources/img/penmedia1.png">
			</a>
		</div>
