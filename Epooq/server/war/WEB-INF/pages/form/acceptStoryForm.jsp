...
<div class="box-content">
	...
	<fmt:formatDate var="yearTemp" value="${date}" pattern="yyyy" />
	<fmt:formatDate var="monthTemp" value="${date}" pattern="MM" />	
	<fmt:formatDate var="dayTemp" value="${date}" pattern="dd" />
	...
	<form:form action="${pageContext.request.contextPath}/story/saveStory.html" modelAttribute="newStory" method="post" id="savestory" name="savestoryForm" onsubmit="validateForm();">
		<div class="contblock">
			<div class="leftpart">
		        <div class="row">
		        	<label class="inline"><spring:message code="title"></spring:message>:</label>
		        	<!-- <input name="title" type="text" class="medium" /> -->
		        	<form:input path="title" class="medium" maxlength="30" />
		        ...
		        <div class="row">
		        	...
		        	<form:input path="country" class="medium" maxlength="30"/>
		        ...
		        <div class="row">
		        	...
		        	<form:input path="city" class="medium" maxlength="30"/>
		        ...
		        <div class="row">
		        	...
		        	<input id="lattitude" type="text" class="medium" name="lattitude" readonly="true"/>
		        </div>
		        <div class="row">
		        	<label class="inline"></label>
		        	<input id="longitude" type="text" class="medium" name="longitude" readonly="true"/>
		        </div>
		        <div class="row">
		        	<label class="inline"></label>
	  ...
	  <div class="bottomrow">
	  <a href="${pageContext.request.contextPath}/story/form/storyReviewForm.html" class="linkbtn-yellow"><spring:message code="acceptStory.back_to_story"></spring:message></a>
      <a href="#" onclick="saveStory();" class="linkbtn-blue1"><spring:message code="save"></spring:message></a>
