...
<script type="text/javascript">
	...
	{
		var form = document.getElementById("acceptStory");
		var uri=encodeURIComponent($("#imageUpload").val());
	...
	function chageVideoClick(pageIndex){
		document.getElementById("acceptStory").method = "get";
		$("#pageIndex").val(pageIndex);
		document.getElementById("acceptStory").action = "${pageContext.request.contextPath}/story/addVideoForm.html";
	...
	function chageAudioClick(pageIndex){
		document.getElementById("acceptStory").method = "GET";
		$("#pageIndex").val(pageIndex);
		document.getElementById("acceptStory").action = "${pageContext.request.contextPath}/story/addAudioForm.html";
		document.getElementById("acceptStory").submit();
	}
...
<h1 id="popup_page">
<spring:message code="storyReview.tell_your_story"/> 1/1
...
<div class="box-content">
    ...
    <div class="innercontent">
        	...
        	<c:forEach var="storyPage" items="${newStory.storyPages}" varStatus="pages">
					...
					<div class="storypage">
						...
						<div class="rightpart">
							...
							<div style="text-align: left; margin-top: 2%;">
								<a class="linkbtn-yellow" href="#" onclick="document.getElementById('listIndex').value=${pages.index}; document.getElementById('videoUpload').click(); return false;">Change Video</a>
								<a class="linkbtn-yellow" href="#" onclick="chageVideoClick(${pages.index})"><spring:message code="storyReview.change_video"/></a>
						...
						<c:choose>
								<c:when test="${fn:contains(storyPage.storyContent.type,'video/webcam')}">
									<img class="player-graphics" src="${pageContext.request.contextPath}/resources/img/repeat.png" style="background: #B0B0B0; top: -261px; left: 35px;"></img>
									<embed src="${pageContext.request.contextPath}/${storyPage.storyContent.content}" width="400" height="290" autoplay="false" enablejavascript="true"/>
								</c:when>
								<c:otherwise>
									<video id="player" width="400" height="290" controls="controls">
										<source src="${pageContext.request.contextPath}/${storyPage.storyContent.content}" type="${storyPage.storyContent.type}" ></source>
						...
						<a href="#" onclick="finish();" class="linkbtn-blue" style="display: inline-block; float: none;"><spring:message code="storyReview.finish"/></a>
						<a class="linkbtn-yellow" href="#" onclick="chageVideoClick(${pages.index})"><spring:message code="storyReview.change_video"/></a>
					 	</div>
					</div>
				</c:if> 
				...
				<c:if test="${fn:contains(storyPage.storyContent.type,'audio')}">
				 	<%-- <div class="storypage">
						...
						<div class="rightpart">
							<embed src="${pageContext.request.contextPath}/${storyPage.storyContent.content}" width="400" height="290" autoplay="false" />
							<div style="text-align: left; margin-top: 2%;">
								<a class="linkbtn-yellow" href="#" onclick="chageAudioClick(${pages.index})"><spring:message code="storyReview.change_audio"/></a>
							</div>
						<!-- </div> -->
						<div style="margin-top: 1%;">
							<a href="#" onclick="finish();" class="linkbtn-blue" style="display: inline-block; float: none;"><spring:message code="storyReview.accept_video/audio"/></a>
							<a class="linkbtn-yellow" href="#" onclick="chageAudioClick(${pages.index})"><spring:message code="storyReview.change_audio"/></a>
						</div>
					</div> --%>
				...
				<c:if test="${fn:contains(storyPage.storyContent.type,'image')}">
					<div class="storypage">
						...
						<div style="margin-top: 1%;margin-left: 35%;float: left;">
							<a href="#" onclick="finish();" class="linkbtn-blue" style="display: inline-block; float: none;"><spring:message code="storyReview.finish"/></a>
							<a class="linkbtn-yellow" href="#" onclick="document.getElementById('listIndex').value=${pages.index}; document.getElementById('imageUpload').click(); return false;"><spring:message code="storyReview.change_image"/></a>
					...
					<div class="storypage" style="background: #ededed">
						<p style="padding: 25px">
							<form:textarea path="storyPages[${pages.index}].storyContent.content" form="acceptStory" 
										   rows="15" cols="100" class="textstory"/>
						</p>
						<a href="#" onclick="finish();" class="linkbtn-blue" style="margin-left:45%;"><spring:message code="storyReview.finish"/></a>
					</div>
      ...
      <div class="bottomrow">
   <a style="" onclick="addStoryPage();" class="linkbtn-blue"><spring:message code="storyReview.add_story_page"/></a> 
