...
<script type="text/javascript">
	...
	function checkEmail(){
		...
		if( !(regex.test( email.value )) ) {
			$(".msgbgError").show();
			$("#error_msg").append("<spring:message code="invalid.email"></spring:message>");
		    return false;     
		}
...
<body>
	...
	<h1 id="popup_page"><spring:message code="forgot.message" /><a href="${pageContext.request.contextPath}/home.html" class="close"  style="left: 93%"></a>
	</h1>
	<div class="box-content" onclick="closeError()">
		<div class="row">
	    	...
	    	<div class="msgbg msgbgSuccess" style="display: none;">
	              <div class="msg_left">
	                <div class="msg_right">
	                  		<div class="msg_success"><img alt="" src="${pageContext.request.contextPath}/resources/img/form/ic_success.png"><span id="successs_msg"></span></div>
	                </div>
	              </div>
	    	</div>
 		</div>
		<div class="forgotPasswordSuccess">
		<div class="row"><label class="full"></label></div>	
	    <div class="row"><a href="${pageContext.request.contextPath}/user/loginMain.html" class="inputbutton" ><spring:message code="forgot.click_here_to_login"/></a></div>
	    <div class="bottomrow"><p></p></div>
		</div>
