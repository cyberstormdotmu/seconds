...
function onRecordStop() {
	...
	if($("#pageIndex").val().trim()!=""){
		document.getElementById("recordVideo").action = "${pageContext.request.contextPath}/story/changeWebcamVideoEdit.html";
	}else{
...
function addVideo() {
	...
	document.getElementById("recordVideo").method = "post";
	//alert("Video File Selected");
	...
	/* if(story_mode.value=="EDIT")
	{
		...
		document.getElementById("recordVideo").action = "${pageContext.request.contextPath}/story/edit/changeVideo.html";
	}else{
	...
	function restart()
	{
		...
		var story_mode = document.getElementById("story_mode");
		window.location.replace("${pageContext.request.contextPath}/story/editVideoForm.html?pageIndex="+$("#pageIndex").val().trim());
    			...
    			<div class="storypage" style="display: block;">
						<div class="leftpart" style="height: 100%">
							...
							<div style="text-align: left; margin-top: 100%;">
								...
								<a class="linkbtn-blue" href="#" onclick="stop();"><spring:message code="button.stop"/></a>
