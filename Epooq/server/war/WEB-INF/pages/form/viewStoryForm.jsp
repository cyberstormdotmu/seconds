...
<script type="text/javascript">
	...
	function editStory()
	{
		...
		form.action = "${pageContext.request.contextPath}"+"/story/editStory.html";
		form.method = "post";
		form.submit();
	}
	...
	function removeStory()
	{
		$.confirm({
			...
			confirm: function(button) {
				...
				var form = document.getElementById("form-submit");
				$("#storyId").val("${story.id}");
				form.action = "${pageContext.request.contextPath}"+"/story/removeStory.html";
				form.method = "post";
				form.submit();
