...
<t:genericpage title="">
	...
	<jsp:body>
	<input type="hidden" id="errorMessage" value="${flashScope.message}"/>
	<input type="hidden" id="firstNameHidden" value="${flashScope.user.firstName}"/>
	<input type="hidden" id="emailHidden" value="${flashScope.user.email}"/>
	<input type="hidden" id="confirmEmailHidden" value="${flashScope.user.email}"/>
