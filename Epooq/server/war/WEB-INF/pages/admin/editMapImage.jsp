...
<title>Epooq</title>
<link
	href="${pageContext.request.contextPath}/resources/css/form/form_style.css"
	rel="stylesheet" type="text/css" />
<link
	href="${pageContext.request.contextPath}/resources/css/confirmbox.css"
	rel="stylesheet" type="text/css" />
...
<script type="text/javascript">
	...
	function initialize() {
		...
		if ("${mapImage}" != null && "${mapImage.startLat}" != 0.0) {
			...
			myLatLng = new google.maps.LatLng((mapStartLat + mapEndLat) / 2,
					(mapStartLong + mapEndLong) / 2);
			...
			bounds = new google.maps.LatLngBounds(new google.maps.LatLng(
					mapEndLat, mapEndLong), new google.maps.LatLng(mapStartLat,
					mapStartLong));
	...
	function closePopup() {
		var cancelPage = "${pageContext.request.contextPath}"
				+ "/admin/listMapImage.html";
...
<body>
	...
	<div class="boxpanel storywindow">
		<h1 id="popup_page">
			<spring:message code="editMapImage.message" />
			<a href="#" class="close"></a>
		</h1>
		<div class="box-content">
			<h2 class="bord">
				<spring:message code="uploadMapImage.messageSelect" />
			</h2>
				...
				<div class="msgbg" style="display: none;">
					<div class="msg_left">
						<div class="msg_right">
							<div class="msg_error">
								<img
									src="${pageContext.request.contextPath}/resources/img/form/ic_error.png"
									alt="" onclick="closeError()" /> <span id="error_msg"></span>
							</div>
						</div>
					</div>
				</div>
