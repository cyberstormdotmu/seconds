		...
		<table>
			<tr>
				<td><a href="${pageContext.request.contextPath}/home.html"><img
						 id="epooqLogo" src="${pageContext.request.contextPath}/resources/img/epooqlogo.png"></a></td>
				<td><a id="myepooqlink"><img id="logo"
						src="${pageContext.request.contextPath}/resources/img/omaepooq.png"></a>
				</td>
			
			<td id="search">
							<div id="searchBox">
							<c:if test="${fn:contains(pageContext.request.servletPath, 'home.jsp')}">
								<ul id="filterbutton">
								<li>
...
<!-- 					<td class="login_button"> -->
	...
	<c:choose>
		<c:when test="${fn:contains(pageContext.request.servletPath, 'admin')}">
		</c:when>
		<c:otherwise>
	...
	<div id="footer" >
		...
		<div id="footer_left">
                    <div id="links">
                        <a id="privacy_policy_anchor" href="${pageContext.request.contextPath}/terms/privacy_policy.jsp" ><spring:message code="link.privacy" /></a> - 
                        <a id="terms_of_use_anchor" href="${pageContext.request.contextPath}/terms/termsOfUsage.jsp"><spring:message code="link.terms" /></a> - 
                        <a id="about_anchor" href="${pageContext.request.contextPath}/terms/complaint_policy.jsp"><spring:message code="link.report" /></a>  
                    </div>
        </div>
