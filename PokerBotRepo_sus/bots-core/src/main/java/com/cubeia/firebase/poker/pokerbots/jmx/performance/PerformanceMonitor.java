...
package com.cubeia.firebase.poker.pokerbots.jmx.performance;
...
public class PerformanceMonitor implements PerformanceMonitorMBean {    
    ...
    private static transient Logger logger = Logger.getLogger(PerformanceMonitor.class);
    ...
    private void updateSystemInfo() {
        try {
        	...
        	logger.warn("updateSystemInfo : " + e);
