...
public class SharedExecutorServiceFactory implements ExecutorServiceFactory {

	private final ExecutorService service = Executors.newCachedThreadPool(new NamedThreadFactory("connector-dispatcher"));
