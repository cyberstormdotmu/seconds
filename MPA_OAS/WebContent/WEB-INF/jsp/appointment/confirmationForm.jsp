...
function function1(){
	...
	var status = document.getElementById("agreechk").checked;
	if(status == true)
		{
...
<td width="33%">
<form:form action="${pageContext.request.contextPath}/appointment/confirmationForm.mpa" method="POST" name="confirmForm" commandName="appointmentForm" modelAttribute="appointmentForm">
...
<form:hidden path="emailAddress"/>
				...
				<table width="100%"  class="dynamictable"   cellpadding="5" cellspacing="1"
                                                                    ...
                                                                    <tr class="rowodd">
                                                                        ...
                                                                        <td>
                                                                           <table height="40">
                                                                            ...
                                                                            <tr><td>
                                                                            	<c:forEach var="i" items="${appointmentForm.craftNumbers}">
                                                                            		${i}
                                                                            	</c:forEach>
                                                                            </td></tr>
                                                                            </table>
                                                                ...
                                                                <table width="100%"  cellpadding="5" cellspacing="1">
                                                                    <tr>
                                                                    	<td>
                                                                    	<input id="agreechk" type= "checkbox"/><span style="color: red;"> *</span>I agree the terms & conditions
                                                                    	</td>
                                                                    </tr>
                                                                   <tr>
                                                                    <td>
                                                                    <input type="submit" class= "inputbutton btn_small"  value="Submit" onClick = "javascript:return function1();"/>
                                                                    </td>
                                                                   </tr>                                                                
                                                                   </table>
                                                                </form:form>
