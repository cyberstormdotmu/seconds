...
$(document).ready(function() {
	$('.select li a b').click(function () {
		$(".select_sub").css("display","none");
		$(this).parent().next().css("display","block");
		$(this).parent().next().css("background","url(../images/shared/nav/back_0.gif) repeat scroll 0% 0% transparent; left: 0px; padding: 0px; position: absolute; text-align: left; top: 37px; width: 750px; z-index: 100; font-weight: bold");
		$(this).parent().next().css("left","0px");
		$(this).parent().next().css("padding","0px");
		$(this).parent().next().css("position","absolute");
		$(this).parent().next().css("text-align","left");
		$(this).parent().next().css("top","37px");
		$(this).parent().next().css("width","750px");
		$(this).parent().next().css("z-index","100");
		$(this).parent().next().css("font-weight","bold");
		$(this).parent().next().css("padding-left","-10px !important");
	 });
