...
public class ActionToPacketTranformerVisitor extends DefaultActionVisitor {
	...
	public void visit(ChannelChatAction action) {
	 ...
	 @Override
	 public void visit(WaitingResponseAction action) {
		 WaitingResponsePacket packet = new WaitingResponsePacket();
	     packet.tableid = action.getTableId();
	     packet.waitingplayers = action.waitingplayers;
	     receiver.packetCreated(packet);
	 }
	 
	 @Override
	 public void visit(WaitCheckResponsePacketAction action) {
		 WaitCheckResponsePacket packet = new WaitCheckResponsePacket();
	     packet.tableid = action.getTableId();
	     packet.playerid = action.getPlayerid();
	     receiver.packetCreated(packet);
	 }
    ...
    public void visit(WatchResponseAction action) {
        ...
        packet.tablefullstatus = action.getTablefullstatus();
        receiver.packetCreated(packet);
    }
