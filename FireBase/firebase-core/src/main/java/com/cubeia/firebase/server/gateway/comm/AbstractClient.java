...
public abstract class AbstractClient implements Client {
    ...
    private boolean clientConnectedRemotely;
	...
	public void disconnected() {
		...
		try {
			...
			if  ( !closeForced() ) {
			    if (isClientConnectedRemotely()) {
			        log.trace("client connected on other node - suppressing disconnect logic, client id = " + getId());
			    } else {
    ...
    public void setClientConnectedRemotely(boolean clientConnectedRemotely) {
        this.clientConnectedRemotely = clientConnectedRemotely;
    }
    
    @Override
    public boolean isClientConnectedRemotely() {
        return clientConnectedRemotely;
    }
