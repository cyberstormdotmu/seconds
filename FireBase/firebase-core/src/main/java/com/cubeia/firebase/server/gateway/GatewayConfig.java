...
public interface GatewayConfig extends NodeConfig {
    ...
    /**
     * @return The max idle time for the cometd client, defaults to 300000 (5 min). After this timeout a forced logout packet will be sent to the client.
     * This value must not be less than the {@link #getCometPollTimeout()}.
     */
    @Property(defaultValue="300000")
    public long getCometClientTimeout();
    ...
    /**
     * @return true if cometd is enabled
     */
    @Property(defaultValue="true") 
    public boolean isCometdEnabled();
