...
public class SocketConnectorFactory extends BaseConnectorFactory {
	...
	@Override
	public Connector doCreateConnector(SecurityConfig conf) throws IOException, GeneralSecurityException {
		if(conf == null) {
