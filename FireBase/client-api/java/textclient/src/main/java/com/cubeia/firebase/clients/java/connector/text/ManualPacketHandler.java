...
import com.cubeia.firebase.io.protocol.WaitCheckPacket;
import com.cubeia.firebase.io.protocol.WaitCheckResponsePacket;
import com.cubeia.firebase.io.protocol.WaitingList;
import com.cubeia.firebase.io.protocol.WaitingListPacket;
import com.cubeia.firebase.io.protocol.WaitingResponsePacket;
...
public class ManualPacketHandler extends AbstractClientPacketHandler {
    ...
    public void visit(GameTransportPacket packet) {
    	System.out.println("GameTransportPacket received: "+packet);
    }
	...
	public void visit(WaitingList packet) {
		System.out.println("Call visit(WaitingList packet) inside ManualPackethandler");		
	}

	public void visit(WaitingResponsePacket packet) {
		System.out.println("Call visit(WaitingResponsePacket packet) inside ManualPackethandler");
	}

	public void visit(WaitingListPacket packet) {
		System.out.println("Call visit(WaitingListPacket packet) inside ManualPackethandler");
	}

	@Override
	public void visit(WaitCheckPacket packet) {
		System.out.println("wait check packet");
		
	}

	@Override
	public void visit(WaitCheckResponsePacket packet) {
		System.out.println("wait check packet");
