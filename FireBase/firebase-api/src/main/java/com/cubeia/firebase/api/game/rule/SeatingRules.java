...
public interface SeatingRules {
     ...
     * @param action
     * @param table
     * @return allowed status: <code>J</code>: for Joining, <code>R</code>: for Waiting, <code>D</code>: for Denied 
     */
	public String actionAllowed(JoinRequestAction action, Table table);
