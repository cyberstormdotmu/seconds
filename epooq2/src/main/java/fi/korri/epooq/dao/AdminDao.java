...
public class AdminDao 
{
	...
	public MapImage insertMapImage(MapImage mapImage) throws SQLException
	{
		...
		try
		{
			...
			stmt.setDouble(1, mapImage.getStartLat());
			stmt.setDouble(2, mapImage.getStartLong());
			stmt.setDouble(3, mapImage.getEndLat());
			stmt.setDouble(4, mapImage.getEndLong());
	...
	public List<MapImage> getAllMapImages() throws SQLException
	{
		...
		try
		{
			...
			while(rs.next())
			{
				...
				mi.setStartLat(rs.getDouble("start_lat"));
				mi.setStartLong(rs.getDouble("start_long"));
				mi.setEndLat(rs.getDouble("end_lat"));
				mi.setEndLong(rs.getDouble("end_long"));
	...
	public boolean updateMapImage(MapImage mapImage) throws SQLException
	{
		...
		try
		{
			...
			ps.setDouble(1, mapImage.getStartLat());
			ps.setDouble(2, mapImage.getStartLong());
			ps.setDouble(3, mapImage.getEndLat());
			ps.setDouble(4, mapImage.getEndLong());
