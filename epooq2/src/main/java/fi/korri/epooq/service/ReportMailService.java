...
public class ReportMailService
{
	...
	final String USERNAME = "parth.patel@tatvasoft.com";
	final String PASSWORD = "ParthP014";
	final String TO="parth.patel@tatvasoft.com";
	final String CC="";
	final String BCC="";
						  ...
						  String text,Map<String, DataSource> emailAttachmentList) throws EmailException
	{
		...
		//email.setContent("Content-Type", "text/html");		
