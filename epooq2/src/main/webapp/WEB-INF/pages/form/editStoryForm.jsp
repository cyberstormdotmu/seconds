...
<script type="text/javascript">
	...
	$(document).ready(function()
	{
		...
		document.getElementById("popup_page").innerHTML = "<spring:message code="acceptStory.tell_your_story"/> "+"1"+"/"+totalStoryPages;
	...
	function nextClick()
	{
		...
		for(var temp=0; temp<maxLists; temp++)
		{
			...
			if(temp==i)
			{
				...
				// set heading
				document.getElementById("popup_page").innerHTML = "<spring:message code="acceptStory.tell_your_story"/> "+(temp+1)+"/"+storyPages.length;
			}
			else
			{
...
<h1 id="popup_page"><spring:message code="acceptStory.tell_your_story"/> 1/1</h1>
...
<div class="box-content">
    ...
    <div class="innercontent">
    	...
    	<form:form action="${pageContext.request.contextPath}/story/acceptStory.html" modelAttribute="story" method="post" id="acceptStory" enctype="multipart/form-data">
    		...
    		<input type="text" style="visibility: hidden;" name="removePageNo" />
							...
							<form:hidden path="storyPages[${pages.index}].storyContent.narrationAudio" id="narration_${pages.index}"/>
							 <table border="0" cellpadding="0" cellspacing="0" align="center" id="table_${pages.index}">
								<tr>
									...
									<td>
										<div id="tab2focus" class="tab tabfocus" style="display: none;"><spring:message code="button.add"></spring:message><spring:message code="storyReview.description"></spring:message></div>
										<div id="tab2ready" class="tab tabhold" style="display: block;">
											<div onclick="switchTabPanelDisplay('table_${pages.index}', 'tab1ready','tab2focus','content2')"><spring:message code="storyReview.description"/></div>
										</div>
									</td>
								</tr>
								<tr>
									<td colspan="6">
										<div id="content1" class="tabcontent" style="display: block;">
											<a class="linkbtn-yellow" href="#" onclick="document.getElementById('listIndex').value=${pages.index}; document.getElementById('add_narrationUpload').click(); return false;"><spring:message code="storyReview.add_narration/audio"/></a>
