...
<t:genericpage title="">
	...
	function alignPopupCenter()
	{
		 ...
		 var divWidth = $("#fgPasswordOverlayInner").width();
		 var divHeight = $("#fgPasswordOverlayInner").height();

		 var top= ((windowHeight/2)- (divHeight/2));
		 var left=((windowWidth/2)- (divWidth/2));
		 
		 $("#fgPasswordOverlayInner").css('top', top);
		 $("#fgPasswordOverlayInner").css('left', left);
