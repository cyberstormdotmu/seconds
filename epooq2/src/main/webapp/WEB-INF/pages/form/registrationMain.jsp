...
<t:genericpage title="">
	...
	<input type="hidden" id="firstNameHidden" value="${user.firstName}"/>
	<input type="hidden" id="emailHidden" value="${user.email}"/>
	<input type="hidden" id="confirmEmailHidden" value="${user.email}"/>
	...
	<span id="registrationOverlayOuter"> 
	    <span id="registrationOverlayInner" style="display: none;">
 ...
 */		    /*width:auto;
	...
	$(document).ready(function(){
		 $("#registrationOverlayInner").load("registrationForm.html");
	...
	function alignPopupCenter()
	{
		 ...
		 var divWidth = $("#registrationOverlayInner").width();
		 var divHeight = $("#registrationOverlayInner").height();

		 var top= ((windowHeight/2)- (divHeight/2));
		 var left=((windowWidth/2)- (divWidth/2));
		 
		 $("#registrationOverlayInner").css('top', top);
		 $("#registrationOverlayInner").css('left', left);
		 $("#registrationOverlayInner").fadeIn(500);
		 $("#registrationOverlayInner").show();
	}
