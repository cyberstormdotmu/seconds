...
<h1 id="popup_page"><spring:message code="register.message"/><a href="${pageContext.request.contextPath}/home.html" class="close"></a></h1>
...
<div class="box-content">
 ...
 <div class="contblock" onclick="closeError()">
    ...
    <div class="rightpart">
        <div class="row"><label class="full"><spring:message code="register.DOB"/></label>
        					<select name="birthDay" class="medium registration-select" >
							 ...
							 <select name="birthMonth" class="medium registration-select">
 ...
 <div class="row"><input name="" type="submit" class="inputbutton" value="Register"/></div>
    <div class="bottomrow"><p><spring:message code="register.already_user"/>&nbsp;&nbsp;<a href="${pageContext.request.contextPath}/user/loginMain.html"><spring:message code="register.please"/><spring:message code="register.login_here"/></a></p></div>
</div>
</div>
</form:form>
</body>
