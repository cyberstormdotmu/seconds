...
<div class="box-content">
	...
	<fmt:formatDate var="year" value="${story.storyDate}" pattern="yyyy" />
	<fmt:formatDate var="month" value="${story.storyDate}" pattern="MM" />	
	<fmt:formatDate var="day" value="${story.storyDate}" pattern="dd" />
