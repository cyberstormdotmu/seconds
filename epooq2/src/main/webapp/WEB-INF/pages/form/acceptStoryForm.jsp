...
<div class="box-content">
	<h2 class="bord"><spring:message code="acceptStory.save_story"></spring:message><span style="padding-left: 230px;"></span><spring:message code="acceptStory.choose_location"></spring:message></h2>
		
	<jsp:useBean id="date" class="java.util.Date"></jsp:useBean>
	<fmt:formatDate var="year" value="${date}" pattern="yyyy" />
	<fmt:formatDate var="month" value="${date}" pattern="MM" />	
	<fmt:formatDate var="day" value="${date}" pattern="dd" />
    ...
    <div class="bottomrow">
    	<a href="${pageContext.request.contextPath}/story/form/storyReviewForm.html" class="linkbtn-blue"><spring:message code="acceptStory.back_to_story"></spring:message></a>
