...
{
	$.confirm({
		text: "Are you sure to delete Map Image: " + title + " ?",
...
<div class="grid-top"><a href="uploadMapImage.html" class="addbtn"><img src="../resources/img/form/add-ic.png" alt="" /><spring:message code="button.add"/></a></div>
<table width="100%" border="0" class="grid" cellpadding="0" cellspacing="0">
          <tr class="grid-title">
            <th align="left">Sr. No.</th>
            <th align="left"><spring:message code="title"/></th>
            <th align="left">North-East Latitude</th>
            <th align="left">North-East Longitude</th>
            <th align="left">South-West Latitude</th>
            <th align="left">South-West Longitude</th>
          ...
          <c:set var="index" value="${(currentPage - 1) * 10}" scope="page"/>
