...
<t:genericpage title="">
    <jsp:attribute name="header">
		...
		<script type="text/javascript">
			...
			{
				$.confirm({
					text: "You havent saved your story! If you close, your story or last changes will be lost.<br />Are you sure you are willing to cancel your story?",
			...
			function alignPopupCenter()
			{
				 ...
				 var divWidth = $("#addstoryoverlayInner").width();
				 var divHeight = $("#addstoryoverlayInner").height();

				 var top= ((windowHeight/2)- (divHeight/2));
				 var left=((windowWidth/2)- (divWidth/2));
				 
				 $("#addstoryoverlayInner").css('top', top);
				 $("#addstoryoverlayInner").css('left', left);
	...
	<input type="hidden" id="view_pageno" value="${viewPageNo}"></input>
