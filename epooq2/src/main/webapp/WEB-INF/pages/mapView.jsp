	...
	<jsp:attribute name="header">
		...
		<jsp:body>
			...
			<c:forEach var="element" items="${model}"> 
				<input type="hidden" id="listSize" value="${model.size()}" />
			...
			<div id="nav" style="">
 				<div id="nav-slider" style="height: 300px;"></div>
 				<!--back to story timeline  -->
 				<a id="connection-button" href="home.html"><img
					src="resources/img/sidos_nappi.png"></a>
 			</div>
			...
			.ajaxStop(function (){
				...
				function initialize() {
					...
					var chestMarker;
					 ...
					 for(var j=0;j<document.getElementById("listSize").value;j++){
